      ...
      result.data.forEach(game => {
        ...
        if (game.away_team == game.bookmakers[0].markets[0].outcomes[0].name) {
          ...
          .set({
            ...
            awayMoneyline: game.bookmakers[1].markets[0].outcomes[0].price,
            homeMoneyline: game.bookmakers[1].markets[0].outcomes[1].price,
            awaySpread: game.bookmakers[1].markets[1].outcomes[0].point,
            homeSpread: game.bookmakers[1].markets[1].outcomes[1].point,
            awaySpreadOdds: game.bookmakers[1].markets[1].outcomes[0].price,
