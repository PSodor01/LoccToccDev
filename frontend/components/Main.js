...
import { fetchUser, fetchUserFollowing, fetchUserBlocking, fetchAllUsers, fetchLikes, fetchFades, fetchNFLGames, fetchNCAAFGames, fetchNCAABGames, fetchMLBGames, fetchNBAGames, fetchEPLGames, fetchNHLGames, clearData } from '../redux/actions/index'
...
const mapDispatchProps = (dispatch) => bindActionCreators({ fetchUser, fetchUserFollowing, fetchAllUsers, fetchUserBlocking, fetchLikes, fetchFades, fetchNFLGames, fetchNCAAFGames, fetchMLBGames, fetchNBAGames, fetchNCAABGames, fetchEPLGames, fetchNHLGames, clearData }, dispatch);
